    ...
    <SPost
     ...
     >
      ...
      <div className="Post Repost _liked _marked">
        <UserElem 
          userImg="./img/users/mark-krahmalev.jpeg" 
          userMainText="Марк Крахмалев" 
        ...
        <SPostControls>
          <div className="icon-wrapper like" onClick={likeClickPost}>
          ...
          <div className="icon-wrapper mark" onClick={markClickPost}>
            <svg
